...
log_file = "/home/itri2026-3090/SO101_diffusion_policy/data/outputs/2026.08.05/17.33.44_train_diffusion_unet_image_so101_image/logs.json.txt"
epochs = []
mse = []
...
plt.tight_layout()
plt.savefig("mse_curve_lr-6.png", dpi=300)
plt.show()
